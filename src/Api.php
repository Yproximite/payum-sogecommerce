...
class Api
{
     ...
     *
     * The transaction can be validated as long as the expiration date of the authorization request has not passed. If the authorization validity period has passed, the payment status changes to
     * EXPIRED. The Expired status is final.
     */
